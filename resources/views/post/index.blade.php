            ...
            <div class="grid md:grid-cols-3 gap-10">
                <div class="md:col-span-2 space-y-6 bg-white p-6 rounded-xl shadow-md mb-6">
                    ...
                    <div class="flex items-center gap-4 mt-6">
                        ...
                        <a href="#" class="text-sm text-gray-500 hover:text-emerald-600"><i class="fas fa-thumbs-up mr-1"></i>
                            <span class="font-semibold">0</span></a>
                ...
                <aside class="space-y-8">
                    ...
                    <div class="bg-white border border-gray-200 p-6 rounded-2xl shadow-sm">
                        <h3 class="text-lg font-semibold mb-4 text-gray-800"><i class="fas fa-star mr-2"></i>Posts
                            Populares</h3>
                        <p class="text-gray-600 text-sm mb-4">Os posts mais lidos.</p>
                        <ul class="space-y-4">
                            @foreach ($mostViewedPosts as $mostViewedPost)
                                <li class="bg-gray-100 border border-gray-200 p-4 rounded-lg">
                                    <a href="{{ route("post.show", $mostViewedPost->slug) }}"
                                        class="text-sm text-emerald-600 hover:underline">{{ $mostViewedPost->title }}</a>
                                    <p class="text-gray-500 text-xs mt-1">Por {{ $mostViewedPost->user->name }} -
                                        {{ $mostViewedPost->post_at->diffForHumans() }}
                                    </p>
                                </li>
                            @endforeach
                        </ul>
