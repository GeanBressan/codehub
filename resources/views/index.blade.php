                ...
                @forelse($posts as $post)
                    <article class="bg-white border border-gray-200 p-6 rounded-2xl shadow-sm hover:shadow-lg transition">
                        ...
                        <div class="flex items-center gap-4 mb-4">
                            <img src="{{ $post->user->cover_path ?? 'https://ui-avatars.com/api/?name=' . urlencode($post->user->name) . '&background=0D8ABC&color=fff'  }}" class="w-10 h-10 rounded-full" alt="avatar">
                            <div>
