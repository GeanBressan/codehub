    ...
    <main class="max-w-7xl mx-auto px-6 mt-10">
        ...
        <div class="grid md:grid-cols-3 gap-10">
                    ...
                    <form action="{{ route('profile.update', $user->id) }}" method="POST"
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $user->name) }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm p-2 mb-4">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="bio" id="bio" rows="4"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm p-2 mb-4">{{ old('bio', $user->bio) }}</textarea>
                        </div>
            ...
            <aside class="space-y-8">
                <div class="bg-white border border-gray-200 p-6 rounded-2xl shadow-sm">
                    <h3 class="text-lg font-semibold mb-3 text-gray-800"><i class="fas fa-close mr-2"></i>Deletar Conta</h3>
                ...
                <div class="bg-white border border-gray-200 p-6 rounded-2xl shadow-sm">
                    <h3 class="text-lg font-semibold mb-3 text-gray-800"><i class="fas fa-image mr-2"></i>Remover Foto de Perfil</h3>
                    <p class="text-gray-600 text-sm mb-4">Se você deseja remover sua foto de perfil, clique no botão abaixo.</p>
                    @if ($user->cover_path)
