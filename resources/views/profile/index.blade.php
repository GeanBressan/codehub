                ...
                <div class="max-w-4xl mx-auto p-6">
                    <div class="flex flex-col md:flex-row md:items-center gap-6">
                        ...
                        <div>
                            ...
                            <div class="flex flex-col md:flex-row md:items-center mt-4 gap-x-4">
                    ...
                    @if ($posts->isEmpty())
                        <p class="text-gray-500 dark:text-gray-300">Nenhum post encontrado.</p>
                    @endif
                    @foreach ($posts as $post)
                        <article class="bg-white border border-gray-200 p-6 rounded-2xl shadow-sm hover:shadow-lg transition mb-4 dark:bg-neutral-950 dark:border-neutral-800">
